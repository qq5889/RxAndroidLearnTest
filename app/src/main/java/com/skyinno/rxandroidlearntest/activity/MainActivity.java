...
import com.skyinno.rxandroidlearntest.activity.MapRxActivity;
import com.skyinno.rxandroidlearntest.activity.SimpleRxActivity;
...
public class MainActivity extends AppCompatActivity implements AdapterView.OnItemClickListener {
    ...
    private void initList() {
        ...
        mList.add(new IntentBean("map变换使用", MapRxActivity.class));
    }
}
